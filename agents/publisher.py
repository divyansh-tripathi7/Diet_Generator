...
class PublisherAgent:
    ...
    def generate_layout(self, research_state: dict):
        sections = '\n\n'.join(f"## {key}\n{value}" for section in research_state.get("research_data") for key, value in section.items())
...
"""
    ...
    async def run(self, research_state: dict):
        ...
        print_agent_output(output="Publishing final diet plan and eateries recommendations report...", agent="PUBLISHER")
