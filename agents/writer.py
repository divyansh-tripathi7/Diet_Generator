...
sample_json = """
{
  ...
  "introduction": "An in-depth introduction to the topic in markdown syntax and hyperlink references to relevant sources.",
    ...
    def write_sections(self, research_state: dict):
        ...
        prompt = [{
            ...
            "content": "You are a research writer. Your sole purpose is to write well-written "
                       "research reports about a topic based on research findings and information, while considering the user's dietary goals and health conditions.\n "
        }, {
            "role": "user",
            "content": f"Today's date is {datetime.now().strftime('%d/%m/%Y')}\n."
                       f"Query or Topic: {query}\n"
                       f"Research data: {str(data)}\n"
                       f"User Profile: Dietary Goals: {dietary_goals}, Health Conditions: {health_conditions}\n"
